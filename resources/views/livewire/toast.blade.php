...
<div class="pointer-events-none fixed top-5 right-5 z-[100] flex flex-col gap-2">
    @foreach ($items as $toast)
        ...
        >
            ...
            <button wire:click="remove('{{ $toast['id'] }}')" class="shrink-0 opacity-70 hover:opacity-100 transition-opacity">
