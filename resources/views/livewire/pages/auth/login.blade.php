...
<div
    ...
    style="background:linear-gradient(135deg,#312e81 0%,#4f46e5 50%,#6366f1 100%);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:16px;font-family:'Inter',system-ui,sans-serif;position:relative"
>
    {{-- Grid background pattern --}}
    <div style="position:absolute;inset:0;background-image:radial-gradient(circle at 1px 1px,rgba(255,255,255,0.06) 1px,transparent 0);background-size:40px 40px;pointer-events:none"></div>

    <div style="width:100%;max-width:420px;position:relative;z-index:1">

        {{-- Logo --}}
        <div style="text-align:center;margin-bottom:32px">
            <div class="floating" style="display:inline-flex;align-items:center;justify-content:center;width:64px;height:64px;background:rgba(255,255,255,0.2);border-radius:16px;margin-bottom:16px">
        ...
        {{-- Login Card --}}
        <div style="backdrop-filter:blur(20px);background:rgba(255,255,255,0.95);border-radius:16px;box-shadow:0 25px 60px rgba(0,0,0,0.2);overflow:hidden">
            ...
            <div style="display:flex;padding:16px 16px 0;gap:4px">
                <button
                    ...
                    @if($loginMode === 'staff')
                        style="padding:10px 24px;border-radius:10px 10px 0 0;font-size:13px;font-weight:600;cursor:pointer;transition:all 0.2s;border:none;outline:none;background:#4f46e5;color:#fff"
                    @else
                        style="padding:10px 24px;border-radius:10px 10px 0 0;font-size:13px;font-weight:600;cursor:pointer;transition:all 0.2s;border:none;outline:none;background:#f1f5f9;color:#475569"
                    @endif
                >
            ...
            <div style="padding:32px">
                ...
                {{-- Inline error --}}
                @if ($errorMessage)
                    <div style="margin-bottom:16px;padding:12px 14px;background:#fef2f2;border:1px solid #fecaca;border-radius:12px;font-size:13px;color:#dc2626;display:flex;align-items:center;gap:8px">
                ...
                <form wire:submit="login">
                    ...
                    <div style="margin-bottom:16px">
                        ...
                        <div style="position:relative">
                            <input type="email" wire:model="email" required placeholder="Enter your email"
                                class="form-input"
                                style="width:100%;padding:12px 14px 12px 44px;border:1px solid #e5e7eb;border-radius:12px;font-size:14px;transition:all 0.2s;background:#f9fafb;outline:none;font-family:inherit"
                                onfocus="this.style.background='#fff';this.style.borderColor='#818cf8';this.style.boxShadow='0 0 0 3px rgba(99,102,241,0.1)'"
                                onblur="this.style.background='#f9fafb';this.style.borderColor='#e5e7eb';this.style.boxShadow='none'">
                            <i class="fas fa-envelope" style="position:absolute;left:14px;top:50%;transform:translateY(-50%);color:#94a3b8;font-size:14px;pointer-events:none"></i>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:16px">
                        ...
                        <div style="position:relative">
                            <input type="{{ $showPassword ? 'text' : 'password' }}" wire:model="password" required placeholder="Enter your password"
                                style="width:100%;padding:12px 44px 12px 44px;border:1px solid #e5e7eb;border-radius:12px;font-size:14px;transition:all 0.2s;background:#f9fafb;outline:none;font-family:inherit"
                                onfocus="this.style.background='#fff';this.style.borderColor='#818cf8';this.style.boxShadow='0 0 0 3px rgba(99,102,241,0.1)'"
                                onblur="this.style.background='#f9fafb';this.style.borderColor='#e5e7eb';this.style.boxShadow='none'">
                            ...
                            <button type="button" wire:click="$toggle('showPassword')"
                                style="position:absolute;right:12px;top:50%;transform:translateY(-50%);color:#9ca3af;cursor:pointer;background:none;border:none;font-size:14px;padding:4px">
                    ...
                    <div style="margin-bottom:20px;display:flex;align-items:center;justify-content:space-between">
                        <label style="display:flex;align-items:center;gap:8px;cursor:pointer">
                            <input type="checkbox" wire:model="remember"
                                style="border-radius:4px;border:1px solid #d1d5db;color:#4f46e5;width:16px;height:16px">
                    ...
                    <button type="submit"
                        ...
                        @if($loading)
                            <div style="width:18px;height:18px;border:2px solid rgba(255,255,255,0.3);border-top-color:#fff;border-radius:50%;animation:spin 0.6s linear infinite;flex-shrink:0"></div>
                        @endif
                    </button>
                </form>
                ...
                @if($loginMode === 'staff')
                    <div style="margin-top:24px;padding-top:16px;border-top:1px solid #f3f4f6">
                        <p style="font-size:11px;color:#9ca3af;text-align:center;margin-bottom:12px">Demo Accounts</p>
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
                            <button wire:click="fillDemo('super@madhyam.com', 'admin123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                            ...
                            <button wire:click="fillDemo('rajesh@madhyam.com', 'pass123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                            ...
                            <button wire:click="fillDemo('anil@madhyam.com', 'pass123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                            ...
                            <button wire:click="fillDemo('sita@madhyam.com', 'pass123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                ...
                @if($loginMode === 'client')
                    <div style="margin-top:24px;padding-top:16px;border-top:1px solid #f3f4f6">
                        <p style="font-size:11px;color:#9ca3af;text-align:center;margin-bottom:12px">Demo Client Accounts</p>
                        <div style="display:grid;gap:8px">
                            <button wire:click="fillDemo('ram@himalayancoffee.com', 'client123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                                <p style="font-size:11px;font-weight:600;color:#374151;margin:0">Himalayan Coffee</p>
                                <p style="font-size:10px;color:#9ca3af;margin:0">ram@himalayancoffee.com</p>
                            </button>
                            <button wire:click="fillDemo('maya@treknepal.com', 'client123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
                            ...
                            <button wire:click="fillDemo('devi@greenleaf.com', 'client123')"
                                style="padding:8px 12px;background:#f9fafb;border:1px solid #f3f4f6;border-radius:8px;text-align:left;cursor:pointer;transition:background 0.15s;font-family:inherit"
                                onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f9fafb'">
        ...
        {{-- Footer --}}
        <p style="text-align:center;color:rgba(255,255,255,0.4);font-size:11px;margin-top:24px">&copy; 2026 Madhyam Agency. All rights reserved.</p>
        <p style="text-align:center;color:rgba(255,255,255,0.3);font-size:10px;margin-top:8px">
            <span style="cursor:pointer" wire:click="resetDemoData"
                x-data
                @click="if(!confirm('Reset all demo data? This will re-seed the database.')){ $event.preventDefault() }">
                Reset Demo Data
            </span>
        </p>
    </div>
