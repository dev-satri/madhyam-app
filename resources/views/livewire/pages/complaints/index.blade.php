    ...
    public function render(): mixed
    {
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div class="w-full sm:w-72"><div class="relative"><i class="fas fa-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs"></i><input type="search" wire:model.live.debounce.250ms="search" placeholder="Search complaints..." class="form-input pl-10 focus:ring-0"></div></div>
            </div>
